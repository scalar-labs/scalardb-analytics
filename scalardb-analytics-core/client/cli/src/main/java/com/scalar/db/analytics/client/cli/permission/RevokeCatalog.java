...
@Command(name = "catalog", description = "Revoke a permission on a catalog")
public class RevokeCatalog implements Callable<Integer> {
  @Option(
      names = {"-p", "--permission"},
  ...
  public Integer call() {
    try {
      ...
      printer().printError(new CommandError("Failed to revoke permission on catalog", e));
